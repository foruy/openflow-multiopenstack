...
from nova.daolicloud.linux import ip_lib

import logging
LOG=logging.getLogger(__name__)
CONF = cfg.CONF
CONF.register_opt(cfg.StrOpt('ext_dev', default=os.environ.get('ext_dev')))
CONF.register_opt(cfg.StrOpt('int_dev', default=os.environ.get('int_dev')))
CONF.register_opt(cfg.StrOpt('br_dev', default='br-int'))
CONF.register_opt(cfg.StrOpt('tap_dev', default='br-tap'))
