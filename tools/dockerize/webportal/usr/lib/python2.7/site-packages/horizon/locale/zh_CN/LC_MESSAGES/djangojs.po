...
#: static/horizon/js/horizon.new.js:10
msgid "Show/Hide VM Login Help Info"
msgstr "显示/隐藏 虚拟机登录帮助提示" 

msgid "Your instances' initial SSH username & password: username=root; password=daoli123."
msgstr "虚拟机SSH初始用户名: root, 密码: daoli123。"

msgid "Please change your instances' initial password immediately upon login"
msgstr "登录后请及时更改您的虚拟机初始密码。"
