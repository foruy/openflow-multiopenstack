...
from daoliagent.lib import SHORT_MAX
...
class PacketARP(PacketBase):
    ...
    def run(self, msg, pkt_ether, pkt_arp, gateway, **kwargs):
        ...
        #    if pkt_arp.src_ip != gateway['ext_ip'] and \
        #            pkt_arp.dst_ip != gateway['ext_ip']:
        #        return True
            #return self.redirect(msg, dp, in_port=in_port,
        ...
        elif (num_ip & 0x0000FFFF == SHORT_MAX - 1):
