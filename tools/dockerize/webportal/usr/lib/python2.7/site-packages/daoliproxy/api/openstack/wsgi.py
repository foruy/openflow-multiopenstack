...
from daoliproxy.api.openstack import xmlutil
...
from daoliproxy.openstack.common import jsonutils
...
class Request(webob.Request):
    ...
    def best_match_content_type(self):
        ...
        if 'daoliproxy.best_content_type' not in self.environ:
            ...
            self.environ['daoliproxy.best_content_type'] = (content_type or
                                                      'application/json')

        return self.environ['daoliproxy.best_content_type']
...
class Resource(wsgi.Application):
    ...
    def _process_stack(self, request, action, action_args,
        ...
        context = request.environ.get('daoliproxy.context')
