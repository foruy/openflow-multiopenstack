...
from daoliproxy.openstack.common import excutils
...
AuthorizationFailure = keystoneclient.AuthorizationFailure
Conflict = novaclient.Conflict
...
class ProxyException(Exception):
    ...
    def __init__(self, message=None, **kwargs):
        ...
        super(Daoliproxy, self).__init__(message)
