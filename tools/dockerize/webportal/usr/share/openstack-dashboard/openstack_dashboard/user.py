...
def create_user_from_token(request, token, endpoint, services_region=None, avail_zone=None):
...
class User(models.AnonymousUser):
    ...
    def __init__(self, id=None, token=None, user=None, tenant_id=None,
                 ...
                 domain_name=None, project_id=None, project_name=None, avail_zone=None):
        self.id = id
        self.pk = id
        self.token = token
        self.username = user
    ...
    @property
    def avail_zone(self):
        return self._avail_zone

    @avail_zone.setter
    def avail_zone(self, avail_zone):
        self._avail_zone= avail_zone
...
class AuthUser(User):
    ...
    def __init__(self, id=None, username=None,
                 token=None, enabled=True):
        self.id = id
        self.pk = id
        self.username = username
        self.token = token
        self.roles = [{'name': ('admin'
            if 'admin' == username else 'member')}]
        self.enabled = enabled
