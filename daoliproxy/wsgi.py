...
from daoliproxy.i18n import _, _LE, _LI

wsgi_opts = [
    cfg.StrOpt('api_paste_config',
               default="api-paste.ini",
               help='File name for the paste.deploy config for daoliproxy'),
...
class Server(object):
    ...
    def __init__(self, name, app, host='0.0.0.0', port=0, pool_size=None,
        ...
        :returns: None
        :raises: daoliproxy.exception.InvalidInput
        """
        ...
        self._logger = logging.getLogger("daoliproxy.%s.wsgi.server" % self.name)
...
class Loader(object):
    ...
    def load_app(self, name):
        ...
        :raises: `daoliproxy.exception.PasteAppNotFound`
