...
from proxyclient.i18n import _
from proxyclient import service_catalog
...
class HTTPClient(object):
    ...
    def __init__(self, user=None, password=None, projectid=None, auth_url=None,
    ...
    def _cs_request(self, url, method, **kwargs):
        ...
        try:
            ...
            if self.user_id:
                kwargs['headers']['X-Auth-User-Id'] = self.user_id
            else:
                kwargs['headers']['X-Auth-User-Id'] = self.user
...
def get_client_class(version):
    version_map = {
        '1': 'proxyclient.v2.client.Client',
        '2': 'proxyclient.v2.client.Client',
    }
    try:
