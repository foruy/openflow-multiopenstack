...
class UpdateRow(tables.Row):
    ...
    def get_data(self, request, instance_id):
        ...
        zone = api.proxy.availability_zone_get(request, instance.zone_id)
        if zone:
            instance.zone_id = zone.name

        image_dict = dict((image.imageid, image) for image in
        ...
        gateway_dict = dict((gateway.hostname, gateway.vext_ip)
                for gateway in api.proxy.gateway_get(request, instance_id))
